...
export default function SuccessT2() {
  ...
  const { boyut, hamurlar, malzeme, secimler, toplam } = location.state || {}; // Destructure state
      ...
      <div>
        <div className="backgroundRed flex column padding-l roboto ">
          ...
          <div className="flex column align-center padding-l">
            ...
            <hr></hr>
            <div className="">
              <p className="beyaz font-18">Position Absolute Acı Pizza</p>
              <p className="beyaz font-18">
                <span className="bej font-18 bold">Boyut: </span>
                {boyut}
              </p>
              <p className="beyaz font-18">
                <span className="bej font-18 bold">Hamur: </span>
                {hamurlar}
              </p>
              <p className="beyaz font-18">
                <span className="bej font-18 bold">Ek Malzemeler: </span>
                {malzeme.join(", ")}
              </p>
            </div>
            <div className="flex column beyaz font-22 gap-s marginTop border-beyaz padding-l">
              <span className="bold">Sipariş Toplamı</span>
        ...
        <footer className="siyahBack flex around padding-s">
          <div className="flex column gap-s padding-l max-width-250">
            ...
            <div>
              ...
              <span className="beyaz font-8 barlow">
