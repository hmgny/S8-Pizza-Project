    ...
    <>
      <div id="pizza">
        <section className="flex column just-item-center">
          <main className="backgroundİmg just-item-center padding-l">
            <div>
              <div>
                <img className="flex center tekno-img" src="/public/logo.svg" />
              </div>
              <div className="flex">
                <span className="italik center sari satisfy marginTop ">
                  fırsatı kaçırma
                </span>
              </div>
              <div className="flex column center roboto beyaz font-45 marginTop max-width-s">
                <span className="center">KOD ACIKTIRIR </span>
                <span className="center">PİZZA, DOYURUR</span>
              </div>
              <button
                onClick={handleOrderClick}
                className="flex center just-center align-center sariBack no-border buton-sari font-15 bold marginTop "
              >
                ACIKTIM
              </button>
            </div>
          ...
          <div className="flex just-center">
            <button onClick={handleOrderClick} className="buton">
              <img src="/public/icons/1.svg" />
              Ramen
            </button>
            <button onClick={handleOrderClick} className="buton">
            ...
            <button onClick={handleOrderClick} className="buton">
              <img src="/public/icons/5.svg" />
              Fast food
            </button>
            <button onClick={handleOrderClick} className="buton">
              <img src="/public/icons/6.svg" />
              Soft drinks
            </button>
          </div>
        </section>
        ...
        <section className="bejBack padding-l ">
          <div className="flex just-center gap-s">
            <div className="özel">
              <div className="flex column">
                ...
                <span className="beyaz font-20 barlow">
                  Position:Absolute Acı Burger
                </span>
                <button onClick={handleOrderClick} className="buton-sipariş ">
                  SİPARİŞ VER
                </button>
              </div>
            </div>
          ...
          <div className="flex column align-center padding-l">
            <span className="kirmizi font-22 satisfy italik">
              en çok paketlenen menüler
            </span>
            <span className="font-30 barlow">
          ...
          <div className="flex just-center">
            ...
            <button onClick={handleOrderClick} className="butonSiyah">
              <img src="/public/icons/2.svg" />
              Pizza
            </button>
            <button onClick={handleOrderClick} className="buton">
        ...
        <footer className="siyahBack flex around padding-s">
          <div className="flex column gap-s padding-l max-width-250">
            ...
            <div>
              ...
              <span className="beyaz font-12 barlow">
